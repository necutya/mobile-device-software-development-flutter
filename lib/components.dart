...
Map<int, Composition> liked_compositions = {};
          ...
          child: Row(
            children: [
              ClipRRect(
                  borderRadius:
                      BorderRadius.horizontal(left: Radius.circular(4)),
                  child: Image.asset(this.composition.compositionImage,
                      width: 70, height: 70)),
              SizedBox(
                width: 10,
              ),
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: Row(
                                ...
                                children: [
                                  IconButton(
                                      icon: (liked_compositions.containsKey(
                                              likedCompos.hashCode))
                                          ? Icon(Icons.favorite)
